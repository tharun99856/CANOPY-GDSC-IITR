...
Live: canopy-gdsc-iitr.vercel.app Backend: canopy-gdsc-iitr-production.up.railway.app

What it does
Connect - paste a GitHub PAT, your repos load instantly
Pick - select any repo from your account (public or private)
Visualize - file nodes laid out left-to-right by dependency depth, edges showing import direction
Explore - click any node for a 3-sentence AI summary of what that file does
Search - type a filename, matching nodes highlight, everything else dims
